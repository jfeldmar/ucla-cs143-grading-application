...
class SqlEngine {
 public:
	...
	//Proxy functions
	static void print_tuple(int attr, int key, std::string value);
	static bool check_value_cond(std::string cur_keyValue, std::string l_vBound, std::string u_vBound, std::string valueEqual, 
								 bool isLbEq, bool isUbEq);
	//End Proxy functions
