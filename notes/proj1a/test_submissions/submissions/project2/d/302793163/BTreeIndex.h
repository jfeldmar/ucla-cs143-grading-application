...
class BTreeIndex {
 public:
  ...
  BTreeIndex(int);
  void print();
  void printLeaf( BTLeafNode& );
  void printNonLeaf( BTNonLeafNode& );
  ...
  void setMaxKeyNum(int x) { maxKeyNum = x; }
  int getMaxKeyNum() { return maxKeyNum; }
 ...
 private:
  ...
  static PageId const startPid = 0;
  bool writeMode;
