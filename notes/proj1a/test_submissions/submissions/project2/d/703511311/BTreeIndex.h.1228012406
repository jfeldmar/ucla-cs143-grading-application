...
class BTreeIndex {
 public:
  ...
  RC insert(int key, const RecordId& rid, int currentHeight, PageId currentPid, int& nKey, PageId& nPid);
  ...
  RC locate(int searchKey, IndexCursor& cursor, int currentHeight, PageId currentPid);
