...
private:
	...
	static const int MAX_KEYS = (PageFile::PAGE_SIZE - sizeof(BTLeafNodeHeader)) / sizeof(BTLeafNodeData);
...
private:
	...
	static const int MAX_KEYS = (PageFile::PAGE_SIZE - sizeof(BTNonLeafNodeHeader)) / sizeof(BTNonLeafNodeData);
