...
static const int TOTAL_LEAF_KEYS = 10;	// total number of entries a leaf page can hold
static const int TOTAL_NONLEAF_KEYS = 15;	// total number of entries a non-leaf page can hold
...
class BTLeafNode {
  public:
    ...
    */
	...
	// Convert eight bits to decimal given the position
	int btod(unsigned int pos, unsigned int endPos);

	// Convert a number to eight bits at the given position
	void dtob(unsigned int pos, unsigned int endPos, int n);
