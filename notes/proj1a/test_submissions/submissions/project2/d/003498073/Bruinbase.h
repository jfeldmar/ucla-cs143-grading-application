...
const int RC_FILE_OPEN_FAILED    = -1001; // done in btnodes
const int RC_FILE_CLOSE_FAILED   = -1002; // done in btnodes
const int RC_FILE_SEEK_FAILED    = -1003;
const int RC_FILE_READ_FAILED    = -1004; // done in btnodes
const int RC_FILE_WRITE_FAILED   = -1005; // done in btnodes
...
const int RC_NODE_FULL           = -1010; // done
