...
class BTLeafNode {
  ...
  private:
	...
	int leaf[256];     //size 256.
				   //multiples of 3 are pids, 
				   //multiples of 3 + 1 are sids,
				   //multiples of 3 + 2 are keys.
				   //leaf[255] is the pid that points to the next leaf.
				   //This means there are 85 pointers to records, and one pointer to the next leaf.
...
class BTNonLeafNode {
  ...
  private:
	static const int N = 126;
	int nonleaf[256];   //size 256.
					//even numbers are pids, odd are keys.
  public:
