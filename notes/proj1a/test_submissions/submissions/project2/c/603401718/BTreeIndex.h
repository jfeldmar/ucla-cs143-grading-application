...
//For the page file index, we use pid 0 to store some of the basic information.
...
class BTreeIndex {
 public:
  ...
  RC readForward(IndexCursor& cursor, int& key, RecordId& rid);
	...
	//Helper functions
	void print(int height, PageId pid)
	{
 ...
 private:
	RC insert_helper(int key, const RecordId& rid, int height, int pid, int& r_pid, int& r_key);
