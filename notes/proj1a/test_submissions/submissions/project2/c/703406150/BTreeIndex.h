...
class BTreeIndex
{
 ...
 private:
  ...
  // the first page is used for bookkeeping as a character array
  // the first byte(0) of the first page(pid=0) is the pid of the root node
  // the last byte(1023) contains the pid of the current node
  // bytes 1-1022 contain pids of nodes visited starting after the root
