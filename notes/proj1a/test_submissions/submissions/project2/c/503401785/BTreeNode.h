...
class BTLeafNode {
  public:
    ...
    */
	...
	// ADDED:
	char data[1024];	// 1023 = PageId leafPid
				// 1022 = int leafKeyCount
				// 1021 = PageId leafSibling;
...
class BTNonLeafNode {
  public:
    ...
    */
	...
	// ADDED:
	char data[1024];	// 1023 = PageId nonLeafPid
				// 1022 = int nonLeafKeyCount
				// 1021 = PageId nonLeafFirstPid;
