...
#define INFO_PID 0		// PageId where rootPid and treeHeight info is stored
...
class BTreeIndex {
 public:
  BTreeIndex();		/* BTreeIndex default constructor */
   ...
   */
  RC insertRec(int& key, const RecordId& rid, PageId& nodePid, int level);
