...
class BTreeIndex {
 public:
  ...
  PageId getParentPid(const PageId& pid);
  RC insert_in_parent(PageId nodePid, int key, PageId siblingPid);
  RC locate_helper(int key, PageId pid);
  
  void print_nodes();
  void test_readForward(int searchGreater);  
