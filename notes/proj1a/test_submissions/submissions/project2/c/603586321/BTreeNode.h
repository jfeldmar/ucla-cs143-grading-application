...
#define MAX_LEAF_KEYS (PageFile::PAGE_SIZE - sizeof(int) - 2*sizeof(PageId)) / (sizeof(int) + sizeof(RecordId))
#define MAX_NONLEAF_KEYS (PageFile::PAGE_SIZE - sizeof(int)) / (sizeof(int) + sizeof(PageId))
