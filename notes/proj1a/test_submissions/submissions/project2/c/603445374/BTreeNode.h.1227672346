...
class BTLeafNode {
  ...
  static const int MAX_PAIRS = 84;	//max amount of (key, RecordID) pairs in 1 leaf node
  ...
  BTLeafNode();
    ...
    */
	...
	private:
		char buffer[PageFile::PAGE_SIZE];	//buffer to hold leaf node, char = 1 byte longd
...
class BTNonLeafNode {
  ...
  static const int MAX_PAIRS = 127;	//max amount of (key, PageID) pairs in 1 nonleaf node
  ...
  BTNonLeafNode();
    ...
    */
	...
	private:
		char buffer[PageFile::PAGE_SIZE];	//buffer to hold leaf node
