...
RC SqlEngine::load(const string& table, const string& loadfile, bool index)
{
  ...
  if (table == "debug") {
	  ...
	  int testpid;
	  testnonleaf.initializeRoot(1, 40, 2);
	  testnonleaf.insert (50, 3);
	  testnonleaf.locateChildPtr(20, testpid);
	  cout << "Search for 20: " << testpid << endl;
	  testnonleaf.locateChildPtr(40, testpid);
	  cout << "Search for 40: " << testpid << endl;
	  testnonleaf.locateChildPtr(45, testpid);
	  cout << "Search for 45: " << testpid << endl;
	  testnonleaf.locateChildPtr(50, testpid);
	  cout << "Search for 50: " << testpid << endl;
	  testnonleaf.locateChildPtr(70, testpid);
	  cout << "Search for 70: " << testpid << endl;
