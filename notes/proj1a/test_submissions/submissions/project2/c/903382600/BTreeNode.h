...
class BTLeafNode {
  public:
    ...
    *The maxsize of a pagefile is 1024 thus n = 1024 - 4 = 1020
    *             (recordid + key = 12 bytes) = 1020 / 12 = 85
    *    +1 to compensate for sibling pointer = 86
    *The last 4 bytes on the page is used to point at its sibling leaf node
    *In the page.
    */
   static const int MAX_LEAF_POINTER = 86;
