...
{ 
	PageId pidNewNode = pLeaf->pfIndex.endPid();
	...
	pSibLeaf->pfIndex = pLeaf->pfIndex;

	sibling.setNextNodePtr(getNextNodePtr());
	sibling.write(pidNewNode, pSibLeaf->pfIndex);
	setNextNodePtr(pidNewNode);
...
{ 
	PageId pidNewNode = pNonLeaf->pfIndex.endPid();
	...
	pSibNonLeaf->pfIndex = pNonLeaf->pfIndex;

	sibling.write(pidNewNode, pSibNonLeaf->pfIndex);
