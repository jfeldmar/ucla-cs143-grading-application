...
#define MAX_LEAF_KEYS (PAGE_SIZE - sizeof(int) - 2*sizeof(PageId)) / (sizeof(int) + sizeof(RecordId))
#define MAX_NONLEAF_KEYS (PAGE_SIZE - sizeof(int)) / (sizeof(int) + sizeof(PageId))
