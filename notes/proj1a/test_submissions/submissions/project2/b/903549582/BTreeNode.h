...
const int MAX_POINTERS = 85;
const int MAX_KEYS = MAX_POINTERS - 1;
...
class BTNonLeafNode {
  ...
  private:
		...
		//counting the current number of keys and pointers
		int keyCount;
		int keys[MAX_KEYS];
		int pageIds[MAX_POINTERS];
}; 
