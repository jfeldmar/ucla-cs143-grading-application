...
static const int TOTAL_LEAF_KEYS = 42;	// total number of entries a leaf page can hold
static const int TOTAL_NONLEAF_KEYS = 63;	// total number of entries a non-leaf page can hold
