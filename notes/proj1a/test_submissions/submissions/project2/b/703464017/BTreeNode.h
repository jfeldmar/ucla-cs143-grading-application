...
const int NUM_NONLEAF_PTRS = 127;
const int NUM_LEAF_PTRS = 85;
...
class BTNonLeafNode {
  public:
    ...
    * @return 0 if successful. Return an error code if there is an error.
    */
    RC insertAndSplit(int key, const PageId& pid, BTNonLeafNode& sibling, int& midKey);
